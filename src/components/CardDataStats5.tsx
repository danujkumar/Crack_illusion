...
const CardDataStats5: React.FC<CardDataStatsProps> = ({
  title,
  total,
  rate,
  levelUp,
      ...
      <div className="mt-1 flex-col items-end justify-between">
        ...
        <div className="mt-4 flex-row justify-between">
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Mountains: <span className="text-sm font-medium">None</span>
          </h6>
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Oceans: <span className="text-sm font-medium">None</span>
          </h6>
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Very Cold Latitudes:{" "}
          ...
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Deserts: <span className="text-sm font-medium">None</span>
          </h6>
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Hostile Countries: <span className="text-sm font-medium">None</span>
          </h6>
        </div>
