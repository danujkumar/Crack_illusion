      ...
      <div className="mt-1 flex-col items-end justify-between">
        ...
        <div className="mt-4 flex-row justify-between">
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Altitude: <span className="text-sm font-medium">35,000 feet</span>
          </h6>
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Airspeed: <span className="text-sm font-medium">450 knots</span>
          </h6>
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Fuel Level:{" "}
            <span className="text-sm font-medium">8,000 gallons</span>
          </h6>
          <h6 className="mt-2 text-sm font-bold text-black dark:text-white">
            Engine Health: <span className="text-sm font-medium">97%</span>
          </h6>
        </div>
