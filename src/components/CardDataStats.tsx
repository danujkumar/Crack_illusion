      ...
      <div className="mt-1 flex-col items-end justify-between">
        ...
        <div className="flex-row justify-between mt-4">
          <h6 className="text-sm mt-2 font-bold text-black dark:text-white">
            Flight Number: <span className="text-sm font-medium">{title}</span>
          </h6>
          <h6 className="text-sm mt-2 font-bold text-black dark:text-white">
          Departure: <span className="text-sm font-medium"> New York (JFK) - 14:00</span>
          </h6>
          <h6 className="text-sm mt-2 font-bold text-black dark:text-white">
          Arrival: <span className="text-sm font-medium">Los Angeles (LAX) - 17:30</span>
          </h6>
        </div>
