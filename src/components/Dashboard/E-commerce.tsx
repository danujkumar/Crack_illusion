...
const ECommerce: React.FC = () => {
  return (
    <>
      <div className="">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 xl:grid-cols-4 xl:grid-row-4 2xl:gap-7.5">
          <div className="col-span-1 h-[100vh] md:col-span-2 md:h-auto xl:col-span-3 xl:h-auto">
            <Page />
          </div>
          <div>
            <DropdownMessage/>
